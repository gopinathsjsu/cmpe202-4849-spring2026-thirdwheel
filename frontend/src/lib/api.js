...
export const events = {
    ...
    cancel: (id, reason) => apiRequest(`/events/${id}/cancel`, { method: 'POST', body: JSON.stringify({ reason: reason || '' }) }),
    reschedule: (id, body) => apiRequest(`/events/${id}/reschedule`, { method: 'POST', body: JSON.stringify(body) }),
